...
// tests for MapCustodian2Exchange
void main() {
  final instance = MapCustodian2ExchangeBuilder();
  // TODO add properties to the builder and call build()

  group(MapCustodian2Exchange, () {
    ...
    // String value01
    test('to test the property `value01`', () async {
      // TODO
    });

    // A value01 for this data
    // int value02
    test('to test the property `value02`', () async {
      // TODO
    });
  });
}
