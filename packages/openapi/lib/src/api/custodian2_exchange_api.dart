...
class Custodian2ExchangeApi {
  final Dio _dio;

  final Serializers _serializers;

  const Custodian2ExchangeApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<Custodian2Exchange>>>
    ...
    BuiltList<Custodian2Exchange>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as BuiltList<Custodian2Exchange>;
    ...
    return Response<BuiltList<Custodian2Exchange>>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> mapCustodians2Exchange({
    required String idexchange,
    BuiltList<MapCustodian2Exchange>? mapCustodian2Exchange,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BuiltList, [FullType(MapCustodian2Exchange)]);
      _bodyData =
          _serializers.serialize(mapCustodian2Exchange, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> mapExchanges2Custodian({
    required String idcustodian,
    BuiltList<MapExchange2Custodian>? mapExchange2Custodian,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BuiltList, [FullType(MapExchange2Custodian)]);
      _bodyData =
          _serializers.serialize(mapExchange2Custodian, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
