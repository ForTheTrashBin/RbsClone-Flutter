...
class ExchangeApi {
  ...
  Future<Response<void>> createExchange({
    ...
    try {
      const _type = FullType(ExchangeNoPK);
      _bodyData = _serializers.serialize(exchangeNoPK, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteExchange({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/exchange/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Exchange>> getExchangeById({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/exchange/id/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [Exchange] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Exchange>> getExchangeByShortcode({
    ...
    final _path = r'/exchange/shortcode/{shortcode}'.replaceAll(
        '{' r'shortcode' '}',
