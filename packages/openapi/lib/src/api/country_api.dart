...
class CountryApi {
  ...
  Future<Response<void>> createCountry({
    required CountryNoPK countryNoPK,
    ...
    try {
      const _type = FullType(CountryNoPK);
      _bodyData = _serializers.serialize(countryNoPK, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteCountry({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/country/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Country>> getCountryById({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/country/id/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Returns a [Future] containing a [Response] with a [Country] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Country>> getCountryByShortcode({
    ...
    final _path = r'/country/shortcode/{shortcode}'.replaceAll(
        '{' r'shortcode' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> updateCountry({
    required String id,
    required CountryNoPK countryNoPK,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
