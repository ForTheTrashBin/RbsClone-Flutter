...
class Openapi {
  ...
  /// Get CustodianApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  CustodianApi getCustodianApi() {
  ...
  /// by doing that all interceptors will not be executed
  UtilitiesApi getUtilitiesApi() {
    return UtilitiesApi(dio, serializers);
  }
}
